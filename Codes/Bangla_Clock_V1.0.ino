...
//Version x.x: to be developed if any bug is found
...
void initwifi(void)
{
    ...
    rec_command += sc;
    //rec_command += "BUET-Free-WiFi"; //SSID (BUET)
    rec_command += "Barshan"; //SSID (MY MOBILE)
    //rec_command += "TP-LINK ?"; //SSID (HALL)
    rec_command += sc;
    rec_command += ",";
    rec_command += sc;
    //rec_command += "NULL"; //PASSWORD (USE "NULL" FOR OPEN NETWORKS)
    rec_command += "#SaL8632"; //PASSWORD (HALL)
    rec_command += sc;
    rec_command += "\r\n";
    sendData(rec_command, 2000, 1);        
    delay (1000);
...
void set_eng_date(void)
{
  ...
  else if(rec_data.indexOf("+IPD,132") > 0)
  {
   ...
   // lcd.print("Setting RTC Eng Date");
      ...
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "January") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "January "))
        en_m = 1;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "February") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "February "))
        en_m = 2;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "March") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "March "))
        en_m = 3;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "April") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "April "))
        en_m = 4;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "May") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "May "))
        en_m = 5;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "June") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "June "))
        en_m = 6;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "July ") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "July "))
        en_m = 7;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "August") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "August "))
        en_m = 8;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "September") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "September "))
        en_m = 9;        
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "October") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "October "))
        en_m = 10;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "November") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "November "))
        en_m = 11;
      if(((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "December") || ((rec_data.substring(rec_data.indexOf(",",rec_data.indexOf(",")+1)+2, rec_data.lastIndexOf(",")-2)) == "December "))
        en_m = 12;
